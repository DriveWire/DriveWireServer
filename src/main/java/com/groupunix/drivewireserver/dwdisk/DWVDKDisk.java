...
follow the disk name.
	...
	*/
    ...
    DWVDKDisk(FileObject fileobj) throws IOException, DWImageFormatException {
        super(fileobj);
    ...
    public void load() throws IOException, DWImageFormatException {
        ...
        if (this.fileobj.getContent().getSize() != (this.params.getInt("_sectors") * DWVDKDisk.VDK_SECTOR_SIZE + header.getHeaderLen())) {
