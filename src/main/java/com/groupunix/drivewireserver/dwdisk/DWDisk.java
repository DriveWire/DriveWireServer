...
public abstract class DWDisk {
    ...
    final HierarchicalConfiguration params;
    ...
    // file image
    public DWDisk(FileObject fileobj) {
    ...
    public void insert(DWDiskDrive drive) {
        ...
        for (ConfigurationListener configurationListener : this.params.getConfigurationListeners()) {
