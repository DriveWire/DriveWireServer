...
public class DWVPrinterFX80 implements DWVPrinterDriver {
    ...
    private final DWVSerialCircularBuffer printBuffer = new DWVSerialCircularBuffer(-1, true);

    private final HierarchicalConfiguration config;

    private final double DEF_XSIZE;
    private final double DEF_YSIZE;
    private final double SZ_PICA;
    private final double SZ_ELITE;
    private final double SZ_COMPRESSED;
    ...
    private final DWVPrinterFX80CharacterSet charset = new DWVPrinterFX80CharacterSet();
...
//				vprinter.getLogger().info("wrote print page image to: " + printFile.getAbsolutePath());
    ...
    public File getPrinterFile() throws IOException, DWPrinterFileError {
