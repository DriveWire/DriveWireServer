...
public class DWRawDisk extends DWDisk {
    ...
    DWRawDisk(FileObject fileobj, int sectorsize, int maxsectors) throws IOException, DWImageFormatException {
        super(fileobj);
    ...
    DWRawDisk(FileObject fileobj, int sectorsize, int maxsectors, boolean forcecache) throws IOException, DWImageFormatException {
        super(fileobj);
