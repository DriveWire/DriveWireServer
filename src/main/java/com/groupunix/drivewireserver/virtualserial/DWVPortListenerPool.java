...
public class DWVPortListenerPool {
    ...
    private final SocketChannel[] sockets = new SocketChannel[MAX_CONN];
    private final ServerSocketChannel[] server_sockets = new ServerSocketChannel[MAX_LISTEN];

    private final int[] serversocket_ports = new int[MAX_LISTEN];
    private final int[] socket_ports = new int[MAX_CONN];
