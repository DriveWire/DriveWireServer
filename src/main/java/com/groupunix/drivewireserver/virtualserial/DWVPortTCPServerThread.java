...
public class DWVPortTCPServerThread implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            while ((!wanttodie) && (sktchan.isOpen()) && (dwVSerialPorts.isOpen(this.vport) || (mode == MODE_TERM))) {
        ...
        catch (DWPortNotValidException | DWConnectionNotValidException | IOException e) {
